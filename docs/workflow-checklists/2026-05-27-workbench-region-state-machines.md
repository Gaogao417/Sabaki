...
- [x] step2.1.tests: Write focused runtime companion region and flow outcome tests — role: test-writer — depends_on: step2.1.contract-audit — tests: `test/training/workbenchRuntimeRegion.test.ts` — commit: 197a0cb1 — retry1 submitted after test-audit REQUEST_CHANGES; expected status: RTM-T05/T06/T07/T08 GREEN; RTM-T01/T02/T03/T04/T09/T10 RED until production runtime-region owner is implemented
- [x] step2.1.test-audit: Audit runtime companion tests for fake green / wrong-layer mocks — role: test-auditor — depends_on: step2.1.tests — verdict: REQUEST_CHANGES — audit: `docs/archive/daily-design/2026-05-27/workbench-region-state-machines/runtime-region/test-audit-v0.1.md` — commit: 544abc41
