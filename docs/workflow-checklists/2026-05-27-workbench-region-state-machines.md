...
- [x] step2.1.contract: Contract sketch for runtime companion child-region cleanup — role: contract-designer — depends_on: step1.review — scope: `docs/archive/daily-design/2026-05-27/workbench-region-state-machines/runtime-region/test-contract-v0.1.md` — commit: 58ebd29e — pending contract audit
