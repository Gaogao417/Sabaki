 ...
 * @param {Function} props.onOpenGameLibrary - Called when user opens 资料库
  ...
  function renderContent() {
    ...
    if (state === 'error') {
      return h('div', {class: 'wb-state-error'},
        ...
        h('div', {class: 'wb-state-error__message'}, '当前对局状态异常'),
    ...
    if (state === 'success') {
      return h('div', {class: 'wb-state-success'},
        ...
        h('div', {class: 'wb-state-success__message'}, '已完成'),
      )
    }
